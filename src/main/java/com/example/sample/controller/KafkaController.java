...
import com.example.sample.config.KafkaProperties;
...
public class KafkaController {
    ...
    public KafkaController(KafkaProperties kafkaProperties) {
    ...
    public PublishResult publish(@PathVariable String topic, @RequestParam String message,
        ...
        log.debug("Send to Kafka topic {} with key {} the message : {}", topic, key, message);
    ...
    public SseEmitter consume(@RequestParam("topic") List<String> topics,
        ...
        log.debug("Consume records from Kafka topics {}", topics);
